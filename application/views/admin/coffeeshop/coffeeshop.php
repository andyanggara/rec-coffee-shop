                 ...
                 <div class="mb-3">
                     <div class="btn-actions-pane-left">
                         <div role="group" class="btn-group-sm btn-group">
                             <a class="btn btn-primary" href="<?php echo site_url('coffeeshop/Add') ?>"><i class="fa fa-plus"></i> Tambah</a>
                         </div>
                     </div>
                 </div>
                                 ...
                                 <?php
                                    ...
                                    ?>
                                     <tr>
                                         ...
                                         <td class="text-center"><?php echo $coffeeshop->photo ?></td>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
                 ...
                 <div class="modal-footer">
                     ...
                     <a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/coffeeshopList/delete/<?php echo $coffeeshop->id; ?>">Yes</a>
                 </div>
             </div>
         </div>
     </div>
